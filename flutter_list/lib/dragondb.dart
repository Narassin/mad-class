var dragonData = [
  //000
  {
    ...
    'descriptionD':
        "A Chromatic dragon is a classification of fictional dragon. Chromatic dragons are typically of evil alignment, in contrast to the metallic dragons, which are typically of good alignment.  Tiamat is the queen of chromatic dragons, based on the evil mother of all dragons from Babylonian mythology.",
  },
  //001
  {
    'entryName': 'Metallic Dragon',
    'descriptionD':
        "Metallic dragon is a classification of dragon found in the role playing game Dungeons & Dragons. In this setting metallic dragons are of good alignment. Bahamut is the deity of good-aligned dragons and metallic dragons, and currently the only known Platinum dragon in existence.",
  },
  //002
  {
  ...
  //004
  {
    ...
    'descriptionD':
        "The Lung dragons, originally known as Oriental dragons, are all of neutral alignment with respect to good and evil. They are wingless creatures, and fly by innate magical means. Lung dragons can have any colour despite their specific type.[48] These dragons are derived from Chinese mythology.",
  },
  //005
  {
  ...
  //006
  {
    ...
    'descriptionD': "Planar dragons inhabit the outer planes.",
  },
  //007
  {
    'entryName': 'Drake',
  ...
  //008
  {
    'entryName': 'Wyverns',
    'descriptionD':
        "Dragon-like in overall appearance, the wyvern features a serpentine head, wings, scales, but only two legs and no breath weapon. Its tail is equipped with a poisonous tail stinger.",
  },
];
